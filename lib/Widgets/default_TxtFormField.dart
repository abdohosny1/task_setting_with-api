  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(
          vertical: 8, horizontal: widget.horizontalMargin!),
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                filled: true,
                hintStyle: TextStyle(
                    color: widget.textColor ?? Colors.black45, fontSize: 14),
