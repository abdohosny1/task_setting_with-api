...
class ForthViewUnits extends StatefulWidget {
  const ForthViewUnits({Key? key}) : super(key: key);

  @override
  _ForthViewUnitsState createState() => _ForthViewUnitsState();
}

class _ForthViewUnitsState extends State<ForthViewUnits> {
  bool val = false;
  Object _value = 1;
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Padding(
            padding:
                const EdgeInsets.only(left: 18.0, right: 8, top: 18, bottom: 10),
            child: Container(
